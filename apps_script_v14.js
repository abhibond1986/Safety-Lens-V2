...
function getSailPrompt(promptMode) {
  return 'You are a senior industrial safety inspector for SAIL '
    ...
    + 'When reporting LOF, set type = "Line of Fire" and cite the relevant FA 1948 section from the verified table.\n\n'
    ...
    + '3. Corrosion/equipment integrity → FA 1948 S40 (safety of buildings '
    + 'and machinery) or FA 1948 S39 (defective parts test).\n'
    + '4. IS 14489:2018 is an AUDIT standard — do NOT cite it for individual hazards.\n'
    + '5. S19 is "Latrines & Urinals" — NEVER cite for safety violations.\n'
    + '6. ONLY cite regulations from the VERIFIED TABLE above.\n'
    + '7. If unsure which regulation applies, use "General safety principles".\n'
